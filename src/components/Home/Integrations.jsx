                ...
                <div className={styles.grid}>
                    ...
                    <div className={styles.visualContainer}>
                        <div className={styles.hubWrapper}>
                            ...
                            <svg className={styles.connectorSvg} viewBox="0 0 500 300">
                                {/* Defs for gradients */}
                                <defs>
                                ...
                                <line x1="80" y1="150" x2="210" y2="150" stroke="url(#gradInput)" strokeWidth="3" strokeDasharray="6 4" />

                                {/* Output Lines (Center to Hubs) */}
                                {/* Top */}
                                <line x1="290" y1="150" x2="420" y2="70" stroke="url(#gradOutput)" strokeWidth="2" />
                                {/* Middle */}
                                <line x1="290" y1="150" x2="430" y2="150" stroke="url(#gradOutput)" strokeWidth="2" />
                                {/* Bottom */}
                                <line x1="290" y1="150" x2="420" y2="230" stroke="url(#gradOutput)" strokeWidth="2" />
                            </svg>
                            ...
                            <div className={styles.outputNodes}>
                                {/* HubSpot */}
                                <div className={`${styles.outputNode} ${styles.node1}`}>
                                    <img src="https://cdn.worldvectorlogo.com/logos/hubspot.svg" alt="HubSpot" />
                                </div>

                                {/* Zoho */}
                                <div className={`${styles.outputNode} ${styles.node2}`}>
                                    <img src="https://cdn.worldvectorlogo.com/logos/zoho-1.svg" alt="Zoho" />
                                </div>

                                {/* Calendly */}
                                <div className={`${styles.outputNode} ${styles.node3}`}>
