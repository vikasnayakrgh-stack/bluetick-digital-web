...
const GradientWaves = ({
  ...
  useEffect(() => {
    ...
    if (!capabilities.allowWebGL) {
      container.classList.add('gradient-waves-fallback');
      return () => {
        container.classList.remove('gradient-waves-fallback');
      };
    }
    ...
    try {
      ...
      console.warn('[GradientWaves] WebGL not supported or context lost. Using CSS fallback.', err);
      container.classList.add('gradient-waves-fallback');
      return () => {
        container.classList.remove('gradient-waves-fallback');
      };
